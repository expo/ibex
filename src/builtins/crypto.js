...
// @ref LLP 0012#decision — requiring crypto must NOT rewrite process.versions.
// The runtime-identity authority (process.ts) ships only truthful ambient keys
// (ibex/node/hermes); the ambient v8/uv/openssl/modules masquerade this file
// used to install on load violated that and clobbered versions.ibex
// (ENG-23456). Fixture-only keys come through the harness escape hatch
// (EXACT_COMPAT_TEST), never from an ambient require('crypto').
