...
distribution. This transport evidence is not a qualification of the complete
JavaScript standard-library surface or of Snapback Linux publication: pinned
Hermes's non-Apple `Intl.NumberFormat` remains an explicit dummy and fails the
consumer's real-runtime witness. That gap is tracked in
