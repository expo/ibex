(function portableWebGpuTestWrapperFactory(plan) {
  var wrapperStates = new WeakMap, featureStates = new WeakMap, clientStates = new WeakMap, promiseStates = new WeakMap, prototypes = Object.create(null), routes = Object.create(null), nextRealmToken = 1;
  ...
  function serviceCall(client, call, argumentBody, pendingPromise, errorSpec) {
    var clientState = requireClient(client), sealedLocalTimelinePrefix = flushLocalPrefix(call.device), localTimelineInvalid = !1;
  ...
  defineMethod(prototypeFor("GPUTexture"), "destroy", function() {
    var texture = requireReceiver(this, "GPUTexture"), call = beginPublic(texture.realm, "GPUTexture.destroy", texture, null), payload = {
      mintOrigin: texture.currentOrigin || null,
