(function() {
  ...
  // @ref LLP 0008#crypto — platform crypto backends supply native primitives;
  // every target still resolves the canonical manifest-owned Node surface.
  // A target-local module here would shadow its reviewed exports and failure
  // semantics before the authenticated builtin resolver can load them.
  var internalModules = {
