...
- **Public residual scenarios — 18,325 current Apple rows.** The original
...
1. **Implement the internally-verified reclassification** for the six proven
   ...
   **DONE and audited (2026-07-24):** `INTERNALLY_VERIFIED_SCENARIOS` is a
   ...
   Apple 2,601 fully executable / 3,114 internally verified / 18,325 unresolved;
...
2. **Public-residual authoring program (currently 18,325 Apple rows) — it is a
