...
`ASSIGNED + NOT_ADMITTED + OBJECT` form is instead a self-contained operation
terminal for a fresh service-detached already-lost device and consumes no
