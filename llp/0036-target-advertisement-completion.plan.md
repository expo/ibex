...
- **Public residual scenarios — 18,305 current Apple rows.** The original
...
1. **Implement the internally-verified reclassification** for the six proven
   ...
   **DONE and audited (2026-07-24):** `INTERNALLY_VERIFIED_SCENARIOS` is a
   ...
   Apple 2,621 fully executable / 3,114 internally verified / 18,305 unresolved;
...
2. **Public-residual authoring program (currently 18,305 Apple rows) — it is a
