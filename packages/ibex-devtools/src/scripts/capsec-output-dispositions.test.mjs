...
describe("LLP 0023 output-disposition dataset", () => {
  ...
  test("accounts for all 7,356 covered surfaces and emits 6,413 context-bound output rows", async () => {
  ...
  test("blocks verified promotion while any source surface is unresolved", async () => {
    ...
    ).toThrow(/verified output catalog has 58 unresolved surface accounts/);
  }, 30_000);
