...
The registry contains 7201 semantic coverage edges, including 0 conditional-unrefined edges. 0 exact target(s) are advertised from verified conformance reports.
...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| aarch64-apple-darwin | hermes-frame-attribution, native-compartments, native-lockdown | 7096 | 112 | 0 | 0 | 0 | 0 | 7201 |
