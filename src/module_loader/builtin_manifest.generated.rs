...
pub(crate) const BUILTIN_MANIFEST_REGISTRATIONS: &[BuiltinManifestRegistration] = &[
    ...
    BuiltinManifestRegistration {
        ...
        source_key: "exact_crypto",
    },
    BuiltinManifestRegistration {
        specifier: "exact:clipboard",
        source_key: "exact_clipboard",
    },
    BuiltinManifestRegistration {
        specifier: "exact:http",
        source_key: "exact_http",
    },
    BuiltinManifestRegistration {
        specifier: "exact:sqlite",
        source_key: "exact_sqlite",
    },
    BuiltinManifestRegistration {
    ...
    BuiltinManifestRegistration {
        specifier: "harness",
        source_key: "bun_harness",
    },
    BuiltinManifestRegistration {
        specifier: "node-harness",
        source_key: "node_harness",
    },
    BuiltinManifestRegistration {
        specifier: "bun:jsc",
        source_key: "bun_jsc",
    ...
    BuiltinManifestRegistration {
        ...
        source_key: "bun_internal_for_testing",
    },
    BuiltinManifestRegistration {
        specifier: "node:test",
        source_key: "node_test_alias",
    },
    BuiltinManifestRegistration {
        specifier: "bun:fs",
        source_key: "node_fs",
    ...
    BuiltinManifestRegistration {
        ...
        source_key: "legacy_stream_readable",
    },
    BuiltinManifestRegistration {
        specifier: "_stream_writable",
        source_key: "legacy_stream_writable",
    },
    BuiltinManifestRegistration {
        specifier: "_stream_duplex",
        source_key: "legacy_stream_duplex",
    },
    BuiltinManifestRegistration {
        specifier: "_stream_transform",
        source_key: "legacy_stream_transform",
    },
    BuiltinManifestRegistration {
        specifier: "_stream_passthrough",
        source_key: "legacy_stream_passthrough",
    },
    BuiltinManifestRegistration {
        specifier: "node:stream/consumers",
        source_key: "node_stream_consumers",
    },
    BuiltinManifestRegistration {
    ...
    BuiltinManifestRegistration {
        ...
        source_key: "node_stream_promises",
    },
    BuiltinManifestRegistration {
    ...
    BuiltinManifestRegistration {
        ...
        source_key: "util_types_alias",
    },
    BuiltinManifestRegistration {
        specifier: "node:util/types",
        source_key: "node_util_types_alias",
    },
    BuiltinManifestRegistration {
        specifier: "node:timers",
        source_key: "node_timers",
    },
    BuiltinManifestRegistration {
        specifier: "timers",
        source_key: "node_timers",
    ...
    BuiltinManifestRegistration {
        ...
        source_key: "node_timers_promises",
    },
    BuiltinManifestRegistration {
    ...
    BuiltinManifestRegistration {
        ...
        source_key: "node_string_decoder",
    },
    BuiltinManifestRegistration {
    ...
    BuiltinManifestRegistration {
        ...
        source_key: "node_worker_threads",
    },
    BuiltinManifestRegistration {
    ...
    BuiltinManifestRegistration {
        ...
        source_key: "node_diagnostics_channel",
    },
    BuiltinManifestRegistration {
