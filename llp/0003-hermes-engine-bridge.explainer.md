...
1. Builds a `hermes::vm::RuntimeConfig` with a microtask queue, `eval`, and
   ...
   source-compilation profile ([LLP 0026](./0026-hermes-es6-block-scoping.decision.md);
