...
describe("builtin non-capability/closed output recipes", () => {
  test("accounts for the exact callable/accessor and descriptor residual universe", async () => {
    ...
    // Bounded HTTP/HTTPS/net/UDP/TLS calls, including exact terminal
    ...
    ).toEqual({ "non-capability": 302, closed: 220 });
    expect(
      ...
      residualReasons: {
        ...
        "receiver-needs-external-or-network-lifecycle": 52,
    ...
    // bounded public probes. Those 91 rows are
