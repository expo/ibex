...
export const REQUIRED_INGRESS_OBLIGATIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    sourceEvidence: Object.freeze([
      ...
      freezeEvidence("src/engine/hermes_runtime.cc", [
        ...
        "structuredDeclarationPlanFeasible(runtime, plan)",
  ...
  Object.freeze({
    ...
    assertion:
      "Direct-file execution selects only the authenticated File/Program route; its native file adapter retains descriptor capture and a readiness lease across Runtime construction and settlement, while Runtime claims the closed AuthenticatedFileIngress before evaluation.",
    sourceEvidence: Object.freeze([
      ...
      freezeEvidence("src/bin/ibex/runtime.rs", [
        "async fn run_authenticated_file_with_args(&self, args: &[String])",
...
const REVIEWED_INGRESS_SOURCE_RANGES = Object.freeze({
  ...
  "src/bin/ibex/main.rs": Object.freeze([
    freezeReviewedRange(
      ...
      "sha256-C0ze_miy3zTn_ZAPppgv2kvaZ4Ik8YjkXwYistLnSEo",
    ),
    freezeReviewedRange(
    ...
    freezeReviewedRange(
      ...
      "sha256-9-zUF_81deAGmX-omsBxoRBUJ_Ote54aiLpLMozED58",
    ),
    freezeReviewedRange(
      "authenticated-file-runtime",
      "async fn run_file(",
      "async fn run_file_with_execution_adapter(",
      "sha256-3Cbrm4bQ8FHnNTzufXEZu2cLm6ENLGGagI_UiodF1lE",
    ),
  ]),
  "src/bin/ibex/repl/mod.rs": Object.freeze([
    freezeReviewedRange(
      ...
      "sha256-iVUI5U1M1mU9yDjVEIEv3XzVZUpWL-WzWHyFk0oQa0E",
    ),
  ]),
  "src/bin/ibex/runtime.rs": Object.freeze([
    freezeReviewedRange(
      ...
      "sha256-DgQQTlqhyvifY252Wrmz8gp9p5W7dWG0j9m6flbwHJA",
    ),
    freezeReviewedRange(
      ...
      "sha256-yHaidP7mUJHItDh_Dw4oICYC4uTHfrY6V-irO5BmvMU",
    ),
    freezeReviewedRange(
      "authenticated-file-ingress",
      "impl AuthenticatedFileIngress {",
      "fn expected_identity_from_snapshot(",
      "sha256-5d_L2dilGAybOPiEbQkAb0DntZWYK30IjFp5lZhCfgQ",
    ),
    freezeReviewedRange(
      "runtime-file-execution",
      "    async fn run_authenticated_file_with_args(&self, args: &[String])",
      "    pub async fn run_file_with_args(",
      "sha256-pIrmqZDLATqL8ruuEysvKswOUmWYPNuiyqRFG5t8ACY",
    ),
  ]),
  "src/bin/ibex/terminal_session.rs": Object.freeze([
    freezeReviewedRange(
      ...
      "sha256-OsVqnF93eBUvsxV42_iXenQmnNMBXMqq7IQKU6cLSCA",
    ),
    freezeReviewedRange(
      "repl-unix-adapter",
      "async fn run_repl_unix(",
      "fn read_bounded_transcript_record(",
      "sha256-uDlZQtfjknKheuSMx0W9UssFtaDF9m7DXE8Y0LTRyPo",
    ),
    freezeReviewedRange(
      "file-program-adapter",
      "pub struct FileProgramExecutionAdapter {",
      "struct NativeFd(i32);",
      "sha256-WNGWjzOtHo1PHT1Pqwpi2vA5TqKGcNthQdJDjVTpbr4",
    ),
  ]),
  ...
  "src/engine/hermes_structured.rs": Object.freeze([
    freezeReviewedRange(
      ...
      "sha256-yUiBdB-8qGu3yr7M74i_ALl81VLnr63o-u99FK1o188",
    ),
    freezeReviewedRange(
  ...
  "src/engine/session_lowering.rs": Object.freeze([
    freezeReviewedRange(
      ...
      "sha256-rv6Zbr8eBs5QfkV3-_zFMU6QGl46wnWrUVmKI5PYAhg",
    ),
  ]),
  "src/host/mod.rs": Object.freeze([
    freezeReviewedRange(
      ...
      "sha256-BVAtqsIdiLZlyoUSoG-mzP6jhPWfN0SadffOSS8URXs",
    ),
  ]),
