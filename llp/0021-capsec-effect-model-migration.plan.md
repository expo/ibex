...
**Revised:** 2026-07-18 (Windows public recipes remain residual where platform globals, including setup prerequisites, use legacy capability oracles or their default-source registration is excluded from the target build)
