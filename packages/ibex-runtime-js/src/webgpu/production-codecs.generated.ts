...
export const WEBGPU_EXECUTABLE_CODEC_MANIFEST = {
  ...
  "disposition": "reviewed-generated-injection-and-request-adapter-request-device-create-command-encoder-create-shader-module-device-destroy-payload-codegen-input-native-codec-not-installed-no-support-claim",
  ...
  "nativeCodecPrograms": {
    ...
    "disposition": "request-adapter-request-device-create-command-encoder-create-shader-module-device-destroy-payload-codegen-input-only-native-codec-not-installed-no-support-claim",
    "dispatch": {
