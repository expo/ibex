/**
 * Generate the Draft LLP 0026 restricted Exact embedder projection.
 *
 ...
 *
 * @ref LLP 0026#5-closed-world-surface-projection — total projection with no
 * silent absorption of new full-registry edges.
 * @ref LLP 0026#8-generated-authority-and-conformance — advertisements derive
