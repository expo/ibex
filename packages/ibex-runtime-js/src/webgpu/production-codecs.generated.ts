...
export const WEBGPU_EXECUTABLE_CODEC_MANIFEST = {
  ...
  "publicArguments": [
    ...
    },
    {
      ...
      "wireShape": "closed TypeGPU-0.11.9 GPUBindGroupLayoutDescriptor subset with one-to-five canonical entries and materialized WebIDL defaults",
  ...
  "serviceArguments": [
    ...
    },
    {
      "wireTag": 15,
      "tag": "gpu-create-bind-group-layout-service-request-v1",
      "wireShape": "device receiver plus wrapper-allocated bind-group-layout target and bounded canonical descriptor; no nested handles",
      "ownership": "owned-copy",
      "nativeProgramPrerequisitesRepresented": true,
      "executableFromCurrentAuthenticatedInputs": true,
      "unavailableSemanticFields": []
