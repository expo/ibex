...
(function () {
  var globalObject = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof global ? global : void 0;
      ...
      facade.enqueue = function (chunk, options) {
        ...
        if (state && state.records && isObject(cloned)) {
          state.records.set(cloned, {
            secondBranchDataCloneError: hasTransferMessagePort(transfer)
          });
        }
