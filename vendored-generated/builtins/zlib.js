...
ZlibTransform.prototype._transform = function(chunk, encoding, callback) {
	...
	if (typeof chunk === "string") this._chunks.push(Buffer.from(chunk, encoding));
...
ZlibTransform.prototype._flush = function(callback) {
	...
	try {
		...
		if (this._isDecoder) this.bytesRead = this.bytesWritten;
		this.push(result);
		callback();
	} catch (e) {
		var finalErr = e;
...
function Deflate(opts) {
	...
	ZlibTransform.call(this, function(buf) {
		var level = _opts && _opts.level !== void 0 ? _opts.level : -1;
