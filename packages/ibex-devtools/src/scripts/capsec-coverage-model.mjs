...
const REVIEWED_NON_GLOBAL_NATIVE_OPERATION_NAMES = new Set([
  // Mach-O segment/section selectors used only while binding the loaded Hermes image.
  "__TEXT",
  "__text",
  "__esModule",
  "__exact",
...
const REVIEWED_HERMES_EVALUATOR_REVIEW_ID =
  "hermes-evaluators.e2f9d545ee737b7d6605e7847d43815c15e21f438396d64ace7edcdcb2c56694";
...
function classifyConcreteSurface(surface) {
  ...
  if (surface.kind === "native-op") {
    ...
    if (surface.name === "__TEXT" || surface.name === "__text") {
      return nonCapabilitySpec("internal-data-transform", "WP1");
    }
