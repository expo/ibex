...
const REVIEWED_HERMES_EVALUATOR_REVIEW_ID =
  "hermes-evaluators.b20457102f7afdd20b0b7b2b9fa38400dff17ee6319c463e4b7566f41558375c";
...
const REVIEWED_LOADER_NAMES = reviewedNameSet(
  [
    ...
    "function:javascript:quarantineDevServedModuleTable",
    "function:javascript:rejectRuntimeLoaderOptions",
    "function:javascript:resolveDevServedModule",
    "function:javascript:resolveDevServedSpecifier",
...
const REVIEWED_STARTUP_NAMES = reviewedNameSet(
  [
    ...
    "env:IBEX_CAPSEC_INTERNAL_INVARIANT_BINDING",
    "env:IBEX_CAPSEC_INTERNAL_INVARIANT_EVIDENCE_OUTPUT",
    "env:IBEX_CAPSEC_MAPPED_ENGINE_EVIDENCE_OUTPUT",
    "env:IBEX_CAPSEC_PORTABLE_EVIDENCE_PLAN",
    "env:IBEX_CAPSEC_PUBLIC_BATCH_EVIDENCE_OUTPUT",
    "env:IBEX_CAPSEC_RECIPE_CATALOG",
    "env:IBEX_CAPSEC_SUPERVISOR_COMMAND_IDENTITY_DIGEST",
    "env:IBEX_CDP_LOG",
    ...
    "evaluation:installProcessSetup:stream-enhance",
    "evaluation:installProcessSetup:stream-stability-patch",
    ...
    "install-route:installProcessSetup:installStdioQueryAccessor",
...
function loaderClassification(surface) {
  ...
  if (name.startsWith("route:")) {
    ...
    if (
      /^(?:resolver_boundary_refusal|resolver_canonical_path|resolver_manifest_not_found|resolver_metadata_from_stat|resolver_metadata_from_windows|resolver_stat_is_dir|resolver_stat_is_symlink|resolver_windows_component)$/u.test(
        functionName,
      )
    ) {
      return nonCapabilitySpec("internal-data-transform", "WP1");
  ...
  if (name.startsWith("function:")) {
    ...
    if (
      new Set([
        ...
        "function:javascript:_loadnamedstreaminternal",
        "function:javascript:_resolveaborterror",
        "function:javascript:add",
        "function:javascript:addresolved",
        "function:javascript:addtypescriptsiblings",
        "function:javascript:builtincachekeyfor",
        "function:javascript:compilefallbacksource",
        "function:javascript:compilemodulebody",
        "function:javascript:createeventtargetmodule",
        "function:javascript:devserveddatavalue",
        "function:javascript:devservedimportgatespecifier",
        "function:javascript:devservedlookupcandidates",
        "function:javascript:dropdevservedvitecacheparams",
        "function:javascript:finddevservedbysuffix",
        "function:javascript:idtomoduleid",
        "function:javascript:invokemodulebody",
        "function:javascript:iscompletestaticimportstatement",
        "function:javascript:issamemodule",
        ...
        "function:javascript:normalizedevservedpath",
        "function:javascript:push",
        "function:javascript:resolvedevservedmodule",
        "function:javascript:resolvedevservedspecifier",
        "function:javascript:restoremoduleid",
        "function:javascript:runfallbackmodule",
